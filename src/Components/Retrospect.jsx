...
const Retrospect = () => {
    ...
    return(
        <div className="w-full py-10 md:retrospectmain md:p-10 flex justify-center">
            <div className="rounded-xl w-full lg:w-2/3 h-full">
                <div className="md:h-screen w-full bg-white md:p-10 lg:rounded-t-2xl">
                    <div className="h-full w-full retroshadow lg:rounded-t-2xl bg-white">
                        <div className="h-full w-full flex flex-col md:flex-row items-center ">
                            <div className="my-10 md:my-0 h-1/2 md:h-full w-full md:w-1/3 lg:w-1/2 flex justify-center items-center md:border-dashed md:border-r-4 lg:border-r-[6px] md:border-gray-500">
                ...
                <div className="md:h-screen w-full bg-green-200 md:p-10">
                    <div className="h-full w-full retroshadow">
                        <div className="h-full w-full flex flex-col md:flex-row items-center">
                            <div className="my-10 md:my-0 h-1/2 md:h-full w-full md:w-1/3 lg:w-1/2 flex justify-center items-center md:border-dashed md:border-r-4 lg:border-r-8 md:border-red-400">
                                <p className="text-center text-6xl md:text-6xl lg:text-7xl xl:text-9xl border-b-8 border-dashed h-20 border-red-400 md:border-0">2007 г.</p>
                            </div>
                            <div className="flex flex-col w-full md:w-2/3 lg:w-1/2 h-1/2 md:h-full text-2xl md:text-2xl md:font-semibold lg:font-normal lg:text-3xl xl:text-4xl">
                                <div className="h-1/2 flex justify-center items-start flex-col p-10 md:p-10">
                ...
                <div className="md:h-screen w-full bg-yellow-200 md:p-10">
                    <div className="h-full w-full retroshadow">                    
                        <div className="h-full w-full flex flex-col md:flex-row items-center">
                            <div className="my-10 md:my-0 h-1/2 md:h-full w-full md:w-1/3 lg:w-1/2 flex justify-center items-center md:border-dashed md:border-r-4 lg:border-r-8 md:border-purple-500">
                                <p className="text-center text-6xl md:text-6xl lg:text-7xl xl:text-9xl border-b-8 border-dashed h-20 border-purple-500 md:border-0">2009 г.</p>
                            </div>
                            <div className="flex flex-col w-full md:w-2/3 lg:w-1/2 h-1/2 md:h-full text-2xl md:text-2xl md:font-semibold lg:font-normal lg:text-3xl xl:text-4xl">
                ...
                <div className="md:h-screen w-full bg-orange-200 md:retrospectlast md:p-10">
                    <div className="h-full w-full retroshadow rounded-b-2xl">
                            ...
                            <div className="my-10 md:my-0 h-1/2 md:h-full w-full md:w-1/3 lg:w-1/2 flex justify-center items-center md:border-dashed md:border-r-4 lg:border-r-8 md:border-blue-400">
                                <p className="text-center text-6xl md:text-6xl lg:text-7xl xl:text-9xl border-b-8 border-dashed h-20 border-blue-400 md:border-0">2009 г.</p>
                            </div>
                            <div className="flex flex-col w-full md:w-2/3 lg:w-1/2 h-1/2 md:h-full text-2xl md:text-2xl md:font-semibold lg:font-normal lg:text-3xl xl:text-4xl">
                                <div className="h-1/2 flex justify-center items-start flex-col p-10">
